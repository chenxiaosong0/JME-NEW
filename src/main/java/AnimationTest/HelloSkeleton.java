...
/**
 * @author xiaosongChen
 * @create 2022-10-28 20:50
 * @description :按F1可以显示/隐藏绿色的骨骼调试器；按F2可以启用/禁用骨骼控制器；按F3可以移除/添加Jaime右手的道具。
 */
public class HelloSkeleton extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        System.out.println(jaime.getChildren());//[JaimeGeom-geom-1 (Geometry), debugger (SkeletonDebugger)]
        ...
        animControl.createChannel().setAnim("Wave");
