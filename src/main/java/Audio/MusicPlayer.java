...
public class MusicPlayer extends SimpleApplication {
    ...
    private void initGui() {
        ...
        selectionModel.setSelectionMode(SelectionModel.SelectionMode.Single);// 单选模式
    ...
    private Action rewind = new Action("慢速") {
        @Override
        public void execute(Button source) {
            if (musicSource != null && musicSource.getStatus() == AudioSource.Status.Playing) {
